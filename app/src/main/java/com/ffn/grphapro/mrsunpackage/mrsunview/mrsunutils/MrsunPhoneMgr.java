 ...
 */
public class MrsunPhoneMgr {
    private static MrsunPhoneMgr phoneUtil;

    public static MrsunPhoneMgr getInstance() {
        if (phoneUtil == null) {
            synchronized (MrsunPhoneMgr.class) {
                if (phoneUtil == null) {
                    phoneUtil = new MrsunPhoneMgr();
                }
            }
        }
        return phoneUtil;
...
//    }
    ...
    public static Bitmap getChoosedImage(Activity mContext, Intent data) {
        ...
        try {
            ...
            AppLogMessageMgr.e("ToolPhone", e.getMessage());
        }
