 ...
 */
public class MrsunSpUtils {
    /**
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "mrsun_share_data";
    ...
    public static void putImage(Context mContext, String key, ImageView imageView) {
        ...
        // 将String保存shareUtils
        MrsunSpUtils.put(mContext, key, imgString);
    }
    ...
    public static Bitmap getImage(Context mContext, String key, ImageView imageView) {
        String imgString = (String) MrsunSpUtils.get(mContext, key, "");
        if (!imgString.equals("")) {
            // 利用Base64将我们string转换
